...
var Storage = {};
Storage.VERSION = 1;
Storage.PATH_VERSION = 'com.martinmagni.dinobros/version';
Storage.PREFIX = 'com.martinmagni.dinobros/data/';
...
function tryStartGame() {
    ...
    console.log("Starting game - ADS DISABLED");
